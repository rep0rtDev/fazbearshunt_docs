...
Добавляет музыкальную тему для начала конкретного типа раунда.
...
Возвращает путь к музыке начала раунда. Если для указанного типа музыка не найдена — возвращается музыка обычного раунда.
