...
1. **[О режиме](/guide/introduction.md)** — узнайте, что такое Fazbear's Hunt
2. **[Начало работы](/guide/getting-started.md)** — настройка окружения для разработки
3. **[Первая модификация](/guide/first-modification.md)** — добавьте свой аниматроник из Мастерской Steam

После этого можно нырять в **[справочник API](/reference/player-meta.md)** и **[список хуков](/hooks/)**.
