...
Добро пожаловать на техническую документацию режима **Fazbear's Hunt** для Garry's Mod.

Эта вики — справочник для разработчиков, которые хотят создавать модификации, расширения и собственных аниматроников для режима.
