...
- **[Функции FH](/reference/functions)** — для глубокого изменения поведения
- **[Хуки аниматроников](/hooks/animatronics)** — для перехвата скримеров и т.д.
- **[Способности аниматроников](/hooks/abilities)** — хуки конкретных способностей
