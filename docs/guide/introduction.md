...
| Раздел | Описание |
|---|---|
| **[Руководство](/guide/getting-started)** | Пошаговые гайды, от установки до первой модификации |
| **[Геймплей](/gameplay/rounds)** | Документация по геймплейным системам: раунды, подарки, просветы |
| **[Справочник](/reference/player-meta)** | Полный API: функции, методы, мета-таблицы |
| **[Хуки](/hooks/)** | Все хуки режима с примерами использования |

::: tip Следующий шаг
Перейдите к разделу [Начало работы →](/guide/getting-started), чтобы настроить окружение.
:::